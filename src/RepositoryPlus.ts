import { DeleteResult, FindConditions, ObjectID, ObjectLiteral, Repository, UpdateResult } from "typeorm";
...
export class RepositoryPlus<Entity extends ObjectLiteral> extends Repository<Entity> {
     ...
     * If entities do not exist in the database then inserts, otherwise updates.
     */
    public save<T extends DeepPartial<Entity>>(entities: T[], options?: SavePlusOptions): Promise<Array<T & Entity>>;

    /**
     * Saves a given entity in the database.
     * If entity does not exist in the database then inserts, otherwise updates.
     */
    public save<T extends DeepPartial<Entity>>(entity: T, options: SavePlusOptions & { reload: false }): Promise<T>;

    /**
     * Saves a given entity in the database.
     * If entity does not exist in the database then inserts, otherwise updates.
     */
    public save<T extends DeepPartial<Entity>>(entity: T, options?: SavePlusOptions): Promise<T & Entity>;
    /**
     ...
     */
    public remove(entityOrEntities: Entity | Entity[], options?: RemovePlusOptions): Promise<Entity | Entity[]> {
     ...
     */
    public count(optionsOrConditions?: FindManyPlusOptions<Entity> | FindConditions<Entity>): Promise<number> {
        if (optionsOrConditions) {
            optionsOrConditions = this.addScope(optionsOrConditions);
        }
     ...
     */
    public find(optionsOrConditions?: FindManyPlusOptions<Entity> | FindConditions<Entity>): Promise<Entity[]> {
        if (optionsOrConditions) {
            optionsOrConditions = this.addScope(optionsOrConditions as FindManyPlusOptions<Entity>);
        }
        return this.manager.find(this.metadata.target as any, optionsOrConditions as FindManyPlusOptions<Entity>);
    }
     ...
     */
    public findOne(
        optionsOrConditions?: string | number | Date | ObjectID | FindOnePlusOptions<Entity> | FindConditions<Entity>,
     ...
     * Finds first entity that matches given options.
     */
    public findOneOrFail(id?: string | number | Date | ObjectID, options?: FindOnePlusOptions<Entity>): Promise<Entity>;
     ...
     * Finds first entity that matches given conditions.
     */
    public findOneOrFail(conditions?: FindConditions<Entity>, options?: FindOnePlusOptions<Entity>): Promise<Entity>;
    ...
    private async checkUnique<
        T extends DeepPartial<Entity> | QueryDeepPartialEntity<Entity> | (Array<QueryDeepPartialEntity<Entity>>)
